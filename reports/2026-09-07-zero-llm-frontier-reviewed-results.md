...
2026-09-09 forward correction: the preceding merge requirement describes this historical evidence snapshot. Its PR lineage has since merged; current repository state is recorded in the [reconciliation closeout](2026-09-09-open-pr-reconciliation-closeout.md). The historical measurements above are not reattributed to the new main.
