...
The canonical parity receipt is now `2026-09-08-locomo-cpu-gpu-parity-v2r8.json`, generated after the review corrections. It includes mean_budget_used, validates complete summary schema and binds hashes to the exact parsed buffers. The v2r1 through v2r7 receipts are preserved as prior attempts. The new preview limit is 50; all 25 entries fit, so it is not truncated. The older cap of 25 did not prove the total even though the complete scan now happens to find exactly 25. Per-mode/budget/category counts are in the successor JSON. Near-tie floating-point drift is an inference only: no candidate score/delta trace proves causality. No ranking/tie-breaking/embedding semantics changed.
...
| 2026-09-08-locomo-cpu-gpu-parity.json (capped preview) | 2026-09-08-locomo-cpu-gpu-parity-v2r8.json |
| 2026-09-08-locomo-cpu-gpu-parity-v2r1.json (before review hardening) | 2026-09-08-locomo-cpu-gpu-parity-v2r8.json |
| 2026-09-08-locomo-cpu-gpu-parity-v2r2.json (omits mean_budget_used) | 2026-09-08-locomo-cpu-gpu-parity-v2r8.json |
| 2026-09-08-locomo-cpu-gpu-parity-v2r3.json (before strict-row coverage hardening) | 2026-09-08-locomo-cpu-gpu-parity-v2r8.json |
| 2026-09-08-locomo-cpu-gpu-parity-v2r4.json (before range validation) | 2026-09-08-locomo-cpu-gpu-parity-v2r8.json |
| 2026-09-08-locomo-cpu-gpu-parity-v2r5.json (before canonical aggregate-count binding) | 2026-09-08-locomo-cpu-gpu-parity-v2r8.json |
...
Seventh completed review identified two P2 cohort-completeness gaps. Fingerprint scopes must now equal measured scopes, and every declared grid arm must contain the same nonempty query cohort exactly once with consistent query metadata. Missing queries/arms or fingerprint-only scopes block strict and aggregate parity. v2r8 preserves the real measured results; r1–r7 are retained. Full local correctness: 307 unit tests plus numeric/docs/version-history/whitespace gates.
