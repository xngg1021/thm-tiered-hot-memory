...
def decomposition(artifact):
    ...
    return {'rows_with_timing':count,'rows_with_batch_receipt':batch_rows,
        ...
        'raw_stage_scope':'raw per-row fields include inclusive and amortized diagnostics; not additive; shared clocks are also reported separately',
        ...
        'overlap_semantics':{'fts':'nested in sparse','query_embedding':'sequential: inside retrieval_total; batched: informational share also represented in shared embedding; never add both',
