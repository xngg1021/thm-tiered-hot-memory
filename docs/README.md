...
- Hermes provider：`thm/hermes_plugin.py`
...
- 代表性测试：`tests/test_engine.py`、`tests/test_review_repairs.py`、`tests/test_harness_core.py`、`tests/test_residency_control.py`

## 当前证据边界

Protocol 2 和历史 Hermes E2E 已有远端运行证据。1.4 新控制面首先以 unit/contract test 和 shadow report 形式验收；它**没有**自动改变 T0–T3，也没有在缺少真实任务结果时宣称最优 residency/prefetch/budget policy。
