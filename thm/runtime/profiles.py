...
class RuntimeProfile:
    ...
    def __post_init__(self):
        ...
        if self.policy=='reference' and (self.backend!='torch_fp32' or self.overlap or self.query_batch_size!=1 or self.scorer!='numpy_reference'):raise ValueError('reference is sequential and fixed')
